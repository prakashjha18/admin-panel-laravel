...
@section('content')
    <h3 class="page-title">PURCHASES{{$client->client_gstin}}</h3>
    {!! Form::open(['method' => 'POST', 'route' => ['admin.purchases.update',$client->id,$purchases->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('inv_no', $purchases->inv_no, ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">  
                    ...
                    <select name="company_name" id="company_name" class="form-control" >
                        ...
                        <option  value='{{ $city->gst_in }}' {{  $purchases->company_name==$city->company_name ? 'selected=="selected"' : '' }}>{{ $city->company_name }}</option>
                        @endforeach
                    </select> 
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('date',$purchases->date, ['class' => 'form-control date', 'placeholder' => 'DD/MM/YYYY','required','pattern' => '^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('product_name', $purchases->product_name, ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('hsn_code', $purchases->hsn_code, ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('rate', $purchases->rate, ['step'=>'any','class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('rate'))
                        <p class="help-block">
                            {{ $errors->first('rate') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('qty', $purchases->qty, ['step'=>'any','class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('qty'))
                        <p class="help-block">
                            {{ $errors->first('qty') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <option value="pcs" {{  $purchases->pcs_kgs=='pcs' ? 'selected=="selected"' : '' }}>pcs</option>
                    <option value="kgs" {{  $purchases->pcs_kgs=='kgs' ? 'selected=="selected"' : '' }}>kgs</option>
                    <
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <option value='0' {{  $purchases->gst_rate=='0' ? 'selected=="selected"' : '' }}>0</option>
                    <option value='1' {{  $purchases->gst_rate=='1' ? 'selected=="selected"' : '' }}>1</option>
                    <option value='2.5' {{  $purchases->gst_rate=='2.5' ? 'selected=="selected"' : '' }}>2.5</option>
                    <option value='6' {{  $purchases->gst_rate=='6' ? 'selected=="selected"' : '' }}>6</option>
                    <option value='5' {{  $purchases->gst_rate=='5' ? 'selected=="selected"' : '' }}>5</option>
                    <option value='12' {{  $purchases->gst_rate=='12' ? 'selected=="selected"' : '' }}>12</option>
                    <option value='18' {{  $purchases->gst_rate=='18' ? 'selected=="selected"' : '' }}>18</option>
                    <option value='28' {{  $purchases->gst_rate=='28' ? 'selected=="selected"' : '' }}>28</option>
                    <option value='40' {{  $purchases->gst_rate=='40' ? 'selected=="selected"' : '' }}>40</option>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('total', $purchases->total, ['class' => 'form-control', 'placeholder' => '', 'readonly']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('total'))
                        <p class="help-block">
                            {{ $errors->first('total') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('CGST', $purchases->CGST, ['class' => 'form-control', 'placeholder' => '', 'readonly']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('CGST'))
                        <p class="help-block">
                            {{ $errors->first('CGST') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('SGST', $purchases->SGST, ['class' => 'form-control', 'placeholder' => '', 'readonly']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('SGST'))
                        <p class="help-block">
                            {{ $errors->first('SGST') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('IGST', $purchases->IGST, ['class' => 'form-control', 'placeholder' => '', 'readonly']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('IGST'))
                        <p class="help-block">
                            {{ $errors->first('IGST') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('invoice_amount', $purchases->invoice_amount, ['class' => 'form-control', 'placeholder' => '', 'readonly']) !!}
                    <p class="help-block"></p>
